...
import br.com.maikon.webflux.service.exception.ObjectNotFoundException;
...
@SpringBootTest
@AutoConfigureWebTestClient//Usado para bater os endpoints
class UserControllerImplTest {
    ...
    @MockBean
    private MongoClient mongoClient;//Mocka a conexão com o MongoDB
    ...
    @Test
    @DisplayName("Test endpoint find by id with bad request")
    ...
    @Test
    @DisplayName("Test endpoint find all with bad request")
    void testFindAllWithBadRequest() {
        when(service.findAll()).thenThrow(new ObjectNotFoundException(""));
    ...
    @Test
    @DisplayName("Test endpoint update with bad request")
    ...
    @Test
    @DisplayName("Test delete endpoint with bad request")
    void testDeleteWithBadRequest() {
