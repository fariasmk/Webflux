package br.com.maikon.webflux.service;
...
import br.com.maikon.webflux.repository.UserRepository;
...
class UserServiceTest {
    ...
    void testSave() {
        ...
        StepVerifier.create(result)//Permite verificar o comportamento de um publisher
    ...
    void testUpdate() {
        ...
        when(repository.findById(anyString())).thenReturn(Mono.just(entity));//Mocka o repository.findById(id) do metodo findById
